...
public class MemberDaoImplUsingSpringJdbc implements MemberDao{
	...
	static final String SELECT_ALL = "SELECT memberId, email, name, left(cdata,19) cdate FROM member ORDER BY memberId desc LIMIT ?,?";
	...
	public void insert(Member member) {
		jdbcTemplate.batchUpdate(INSERT, member.getEmail(), member.getPassword(), member.getName());
